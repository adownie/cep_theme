	...
	if (isset($_REQUEST['post_type']))  {
	  if ($_REQUEST['post_type']== 'page')  { 
		...
		if (isset($_POST['display_slider']))  { 
			...
			update_post_meta($post_id, 'display_slider', $display_slider);
		}
...
?>
	...
	<p><strong>Display Slider</strong></p>
	<select name="display_slider" style="width:200px;">
			<option  value="0" <?php if($display_slider==0) {echo 'selected';} ?> >Yes</option>	
			<option  value="1" <?php if($display_slider==1) {echo 'selected';} ?> >No</option>
	</select>

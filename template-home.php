			...
			<div class="clearfix nosidebar">
				<div class="pagecontent">
				     ...
				     <div class="homepage">
						...
						<?php endif; ?>
						<div class="clear"></div>
						<?php if (of_get_option('slogan_home_page')<>'') : ?><div class="koenda-heading-homepage"><h1><?php  echo of_get_option('slogan_home_page'); ?></h1></div><?php endif; ?>
						...
						<div class="koenda-chb last">
							...
							<a class="wpb_button_a" title="Learn More" href="<?php  echo of_get_option('footer_box_3_link'); ?>"><span class="wpb_button  wpb_btn-danger wpb_regularsize">Learn More</span></a>
						</div>
						<?php endif; ?>
                        <div class="clear"></div>						
					</div>	
